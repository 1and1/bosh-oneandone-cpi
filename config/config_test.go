...
var validOCIProperties = OAOProperties{
	APIToken: apiKeyFile,
...
var validOCIPropertiesWithSSHTunnel = OAOProperties{
	APIToken: apiKeyFile,
	//CpiKeyFile: "/path/to/generated/configdir/cpikey.pem",
	//CpiUser:    "fake-provisioned-user",
	//AuthorizedKeys: AuthorizedKeys{
...
var validConfigWithSSH = Config{
	Cloud: Cloud{
		Plugin: "oneandone",
		Properties: CPIProperties{
			OAO:      validOCIPropertiesWithSSHTunnel,
			Agent:    validAgentOptions,
			Registry: validRegistryOptions,
		},
	},
...
var _ = Describe("Validate", func() {
	...
	Context("with valid cloud config", func() {
		...
		Context(" with missing OCIProperties ", func() {
			BeforeEach(func() {
				config.Cloud.Properties = CPIProperties{}
			})
			It("returns invalid oao configuration error", func() {
...
//	var (
//		oaoProperties OAOProperties
//	)
//
//	Describe("DefaultSSHConfig", func() {
//		BeforeEach(func() {
//			oaoProperties = validOCIProperties
//		})
//
//		It("checks default configuration uses private IP for ssh", func() {
//			Expect(oaoProperties.CpiSSHConfig().usePublicIP).To(BeFalse())
//		})
//	})
//})
